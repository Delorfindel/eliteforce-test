...
import type { MarketplaceServiceDetail, ServiceReview } from '@/features/services/types';
...
export async function getProviderServiceDetail(
  ...
  return mapMarketplaceServiceDetail(data as MarketplaceServiceRow, (reviews ?? []) as ReviewRow[]);
}
